...
function initSlickCarousel() {
  ...
  jQuery(".scgSpeakersSlider").slick({
    ...
    dots: true,
    dotsClass:
      "dotsList dotsListii d-flex align-items-center justify-content-center list-unstyled mb-0 mt-2",
    arrows: false,
    responsive: [
      {
        breakpoint: 992,
...
(function () {
  jQuery.fn.fixedSlideBlock = function (options) {
    ...
    return this.each(function () {
      ...
      if (positionType === "auto") {
        positionType =
          !isFixedPositionSupported || isTouchDevice ? "absolute" : "fixed";
      }
          ...
          if (
            ...
            fixedBlock.css({
              ...
              top:
                ...
                d.holderHeight -
                d.blockHeight -
                (d.blockOffset.top - d.holderOffset.top),
            });
          }
      ...
      function positionAbsolute(noAnimation) {
        ...
        fixedBlock
          .stop()
          .css({ position: "absolute", left: d.blockPosition.left });
  ...
  var isFixedPositionSupported = (function () {
    ...
    container.style.cssText =
      "position:absolute;top:9px;left:9px;width:100px;height:100px;background:red;";
    ...
    supported =
      fixedBlock.offsetTop == 7 ||
      fixedBlock.offsetTop == -2 ||
      (!fixedBlock.offsetWidth &&
